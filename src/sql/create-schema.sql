...
create sequence hibernate_sequence start 1 increment 1;
    ...
    alter table album_photos 
       add constraint FK_album_photos_2_photos 
       foreign key (photo_id) 
       references photos;

    alter table album_photos 
       add constraint FK_album_photos_2_album 
       foreign key (album_id) 
       references albums;

    alter table photographer_emails 
       add constraint FK_photographer_emails 
       foreign key (photographer_id) 
       references photographers;

    alter table photographers 
       add constraint FK_photographers_billing_country 
       foreign key (billing_country_id) 
       references countries;

    alter table photographers 
       add constraint FK_photographers_studio_country 
       foreign key (studio_country_id) 
       references countries;

    alter table photos 
       add constraint FK_photo_photographer 
       foreign key (photographer_id) 
       references photographers;

    alter table tagged_persons 
       add constraint FK_tagged_persons_2_person 
       foreign key (person_id) 
       references persons;

    alter table tagged_persons 
       add constraint FK_tagged_persons_2_photo 
       foreign key (photo_id) 
       references photos;
create sequence hibernate_sequence start 1 increment 1;
